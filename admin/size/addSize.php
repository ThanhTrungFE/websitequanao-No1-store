            ...
            <div class="container-fluid p-0 ">
                    ...
                    <div class="col-12">
                        <div class="page_title_box d-flex align-items-center justify-content-between">
                            <div class="page_title_left">
                                <h3 class="f_s_30 f_w_700 text_white">Thêm size</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container pt-5 mt-5">
                    <form action="index.php?act=addSize" method="POST">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Id size</label>
                            <input type="text" name="masize" class="form-control" id="exampleFormControlInput1"disabled>
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Size</label>
                            <input type="text" name="tensize" class="form-control" id="exampleFormControlInput1">
                            <span style="color:red;"><?php echo isset($_SESSION['tensize'])?$_SESSION['tensize']:''?></span>
                        </div>
